...
class org_rep extends data_abstraction
{
    ...
    function edit($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_where("Org_Rep_Id = ? AND Org_Org_Id = ?");

            $bind_params = array('sssiiii',
                                 &$this->fields['Org_Rep_Lname']['value'],
                                 &$this->fields['Org_Rep_Fname']['value'],
                                 &$this->fields['Org_Rep_Midinit']['value'],
                                 &$this->fields['Org_Org_Id']['value'],
    ...
    function check_uniqueness_for_editing($param)
    {
        ...
        $this->set_query_type('SELECT');
        $this->set_where("Org_Rep_Id = ? AND Org_Org_Id = ? AND (Org_Rep_Id != ? OR Org_Org_Id != '$orig_Org_Org_Id')");
