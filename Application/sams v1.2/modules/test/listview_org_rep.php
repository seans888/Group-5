...
//****************************************************************************************
require 'path.php';
init_cobalt('View org rep');

$page_title       = 'ListView: Organization Representatives';
$db_subclass      = 'org_rep';
$html_subclass    = 'org_rep_html';
$arr_pkey_name    = array('Org_Rep_Id','Org_Org_Id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add org rep';
$edit_link        = 'Edit org rep';
$delete_link      = 'Delete org rep';
$view_link        = 'View org rep';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_org_rep.php';
$edit_page        = 'edit_org_rep.php';
$delete_page      = 'delete_org_rep.php';
$view_page        = 'detailview_org_rep.php';
$csv_page         = 'csv_org_rep.php';
$report_page      = 'reporter_org_rep.php';
