...
//****************************************************************************************
require 'path.php';
init_cobalt('View sao');

$page_title       = 'ListView: Student Activities Office (SAO)';
$db_subclass      = 'sao';
$html_subclass    = 'sao_html';
$arr_pkey_name    = array('SAO_Id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add sao';
$edit_link        = 'Edit sao';
$delete_link      = 'Delete sao';
$view_link        = 'View sao';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_sao.php';
$edit_page        = 'edit_sao.php';
$delete_page      = 'delete_sao.php';
$view_page        = 'detailview_sao.php';
$csv_page         = 'csv_sao.php';
$report_page      = 'reporter_sao.php';
