...
class org extends data_abstraction
{
    ...
    function add($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_fields('user_id, Org_Id, Org_Name, Org_Representative, Org_Members, Org_Contact, Org_Dept');
            $this->set_values("?,?,?,?,?,?,?");
    ...
    function edit($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_update("user_id = ?, Org_Name = ?, Org_Representative = ?, Org_Members = ?, Org_Contact = ?, Org_Dept = ?");
