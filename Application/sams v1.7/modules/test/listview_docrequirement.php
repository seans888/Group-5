...
//****************************************************************************************
require 'path.php';
init_cobalt('View docrequirement');

$page_title       = 'ListView: Document Requirements';
$db_subclass      = 'docrequirement';
$html_subclass    = 'docrequirement_html';
$arr_pkey_name    = array('id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add docrequirement';
$edit_link        = 'Edit docrequirement';
$delete_link      = 'Delete docrequirement';
$view_link        = 'View docrequirement';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_docrequirement.php';
$edit_page        = 'edit_docrequirement.php';
$delete_page      = 'delete_docrequirement.php';
$view_page        = 'detailview_docrequirement.php';
$csv_page         = 'csv_docrequirement.php';
$report_page      = 'reporter_docrequirement.php';
