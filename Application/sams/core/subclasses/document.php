...
class document extends data_abstraction
{
    ...
    function edit($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_where("Doc_Id = ? AND Adviser_Org_SAO_SAO_Id = ?");

            $bind_params = array('ssiiiiiiiii',
                                 &$this->fields['Doc_Name']['value'],
                                 &$this->fields['Doc_Description']['value'],
                                 &$this->fields['docRequest_docRequest_Id']['value'],
                                 &$this->fields['docRequest_SAO_SAO_Id']['value'],
    ...
    function delete_many($param)
    {
        $this->set_parameters($param);
        $this->set_query_type('DELETE');
        $this->set_where("Adviser_Org_SAO_SAO_Id = ?");
    ...
    function check_uniqueness_for_editing($param)
    {
        ...
        $this->set_query_type('SELECT');
        $this->set_where("Doc_Id = ? AND Adviser_Org_SAO_SAO_Id = ? AND (Doc_Id != ? OR Adviser_Org_SAO_SAO_Id != '$orig_Adviser_Org_SAO_SAO_Id')");
