...
//****************************************************************************************
require 'path.php';
init_cobalt('Add docrequirement');
...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($dbh_docrequirement->check_uniqueness($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            $dbh_docrequirement->add($arr_form_data);
...
$html->draw_header('Set a Document Requirement', $message, $message_type);
