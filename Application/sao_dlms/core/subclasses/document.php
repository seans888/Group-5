...
class document extends data_abstraction
{
    ...
    function add($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_fields('id, name, description, docRequest_docRequest_Id, docRequest_SAO_SAO_Id, Adviser_Adv_Id, Adviser_Org_Org_Id, Adviser_Org_SAO_SAO_Id, Student Affair Head_SAH_Id, SAO_SAO_Id');
            $this->set_values("?,?,?,?,?,?,?,?,?,?");
    ...
    function edit($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_update("name = ?, description = ?, docRequest_docRequest_Id = ?, docRequest_SAO_SAO_Id = ?, Adviser_Adv_Id = ?, Adviser_Org_Org_Id = ?, Adviser_Org_SAO_SAO_Id = ?, Student Affair Head_SAH_Id = ?, SAO_SAO_Id = ?");
            $this->set_where("id = ? AND docRequest_docRequest_Id = ? AND docRequest_SAO_SAO_Id = ? AND Adviser_Adv_Id = ? AND Adviser_Org_Org_Id = ? AND Adviser_Org_SAO_SAO_Id = ? AND Student Affair Head_SAH_Id = ? AND SAO_SAO_Id = ?");
