...
class org_rep extends data_abstraction
{
    ...
    function add($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_fields('id, lastname, firstname, midinit, Org_Org_Id, Org_SAO_SAO_Id');
            $this->set_values("?,?,?,?,?,?");
    ...
    function edit($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_update("lastname = ?, firstname = ?, midinit = ?, Org_Org_Id = ?, Org_SAO_SAO_Id = ?");
