...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($dbh_adviser->check_uniqueness($arr_form_data)->is_unique)
        {
...
$html->draw_header('Add Adviser', $message, $message_type);
