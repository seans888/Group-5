...
//****************************************************************************************
require 'path.php';
init_cobalt('Add calendar event');
...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($dbh_calendar_event->check_uniqueness($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            $dbh_calendar_event->add($arr_form_data);
...
$html->draw_header('Add Calendar Event', $message, $message_type);
