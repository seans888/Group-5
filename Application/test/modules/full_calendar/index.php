...
$sql = "SELECT id, title, description, venue, start, end, color FROM events ";
...
<head>
    ...
    <title>Student Activities Management System</title>
...
<div class="container">
    <div class="row">
        <div class="col-md-11 text-center">
            ...
            <p class="lead">Student Activities Management System</p>
        </div>
    </div>
    <div class="row">
