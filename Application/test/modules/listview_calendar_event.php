...
$page_title       = 'ListView: Calendar Event';
$db_subclass      = 'calendar_event';
$html_subclass    = 'calendar_event_html';
$arr_pkey_name    = array('id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add calendar event';
$edit_link        = 'Edit calendar event';
$delete_link      = 'Delete calendar event';
$view_link        = 'View calendar event';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_calendar_event.php';
$edit_page        = 'edit_calendar_event.php';
$delete_page      = 'delete_calendar_event.php';
$view_page        = 'detailview_calendar_event.php';
$csv_page         = 'csv_calendar_event.php';
$report_page      = 'reporter_calendar_event.php';
