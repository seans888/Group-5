...
<?php
        if(isset($_POST['submit'])){
                ...
                $q = mysqli_query($con,"UPDATE org_profile SET image = '".$_FILES['file']['name']."' WHERE username = '".$_SESSION['user']."'");
        }
?>
		...
		<?php
        	...
        	echo "<div id='page-bgbtm'>";
               ...
               echo "<h1 class='org-title'><a href='#'>" . ucfirst($rowName['name']) . "</a></h1>";
                     echo  "<div class='post'>";
                                echo "<h2 class='title'><a href='#'>" . ucfirst('User Profile Page')." </a></h2>";
                                echo "<p class='meta'><span class='date'>Organizational Heads</span><span class='posted'> <a href='#'></a></span></p>";
                        ...
                        echo "<h2 class='title'><a href='#'>". ucfirst("Organization's Files")."</a></h2>";
                        echo "<p class='meta'><span class='date'>List of Files</span><span class='posted'><a href='#''></a></span></p>";
                        echo "<div style='clear: both;''>&nbsp;</div>";
                           echo "<div class='entry'>";
                        ...
                        echo "<p class='meta'><span class='date'>List of Documents</span><span class='posted'><a href='#''></a></span></p>";
                        echo "<div style='clear: both;''>&nbsp;</div>";
                           echo "<div class='entry'>";
