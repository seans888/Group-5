...
$page_title       = 'ListView: Calevent Has Org';
$db_subclass      = 'calevent_has_org';
$html_subclass    = 'calevent_has_org_html';
$arr_pkey_name    = array('calEvent_calEvent_Id','calEvent_SAO_SAO_Id','Org_Org_Id','Org_SAO_SAO_Id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add calevent has org';
$edit_link        = 'Edit calevent has org';
$delete_link      = 'Delete calevent has org';
$view_link        = 'View calevent has org';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_calevent_has_org.php';
$edit_page        = 'edit_calevent_has_org.php';
$delete_page      = 'delete_calevent_has_org.php';
$view_page        = 'detailview_calevent_has_org.php';
$csv_page         = 'csv_calevent_has_org.php';
$report_page      = 'reporter_calevent_has_org.php';
