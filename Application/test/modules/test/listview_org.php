...
$page_title       = 'ListView: Org';
$db_subclass      = 'org';
$html_subclass    = 'org_html';
$arr_pkey_name    = array('Org_Id','SAO_SAO_Id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add org';
$edit_link        = 'Edit org';
$delete_link      = 'Delete org';
$view_link        = 'View org';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_org.php';
$edit_page        = 'edit_org.php';
$delete_page      = 'delete_org.php';
$view_page        = 'detailview_org.php';
$csv_page         = 'csv_org.php';
$report_page      = 'reporter_org.php';
