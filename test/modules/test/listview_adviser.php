...
//****************************************************************************************
require 'path.php';
init_cobalt('View adviser');

$page_title       = 'ListView: Adviser';
$db_subclass      = 'adviser';
$html_subclass    = 'adviser_html';
$arr_pkey_name    = array('Adv_Id','Org_Org_Id','Org_SAO_SAO_Id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add adviser';
$edit_link        = 'Edit adviser';
$delete_link      = 'Delete adviser';
$view_link        = 'View adviser';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_adviser.php';
$edit_page        = 'edit_adviser.php';
$delete_page      = 'delete_adviser.php';
$view_page        = 'detailview_adviser.php';
$csv_page         = 'csv_adviser.php';
$report_page      = 'reporter_adviser.php';
