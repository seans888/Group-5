...
$page_title       = 'ListView: Migration';
$db_subclass      = 'migration';
$html_subclass    = 'migration_html';
$arr_pkey_name    = array('version');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add migration';
$edit_link        = 'Edit migration';
$delete_link      = 'Delete migration';
$view_link        = 'View migration';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_migration.php';
$edit_page        = 'edit_migration.php';
$delete_page      = 'delete_migration.php';
$view_page        = 'detailview_migration.php';
$csv_page         = 'csv_migration.php';
$report_page      = 'reporter_migration.php';
